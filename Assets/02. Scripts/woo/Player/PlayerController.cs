...
public class PlayerController : MonoBehaviour
{
    ...
    private void PickUpMirrorPiece(MirrorPiece piece)
    {
        ...
        switch (pieceNum)
        {
            case 1:
                {
                    piece1 = true; curPieceCount++; 
                    SoundManager2.Instance.PlayWarningSFX();
                    PlayerUIHandler.Instance.OnAdviceUI("들킨 것 같다...!");
                    break;
                }
            case 2:
                {
                    piece2 = true; curPieceCount++; 
                    SoundManager2.Instance.PlayWarningSFX();
                    PlayerUIHandler.Instance.OnAdviceUI("들킨 것 같다...!");
                    break;
                }
